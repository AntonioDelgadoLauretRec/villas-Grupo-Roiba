...
const PROJECTS = [
  ...
  },
  {
    ...
    type: 'Resort 5*',
    year: '2022',
    image: '/images/projects/hotel-live-aqua.png',
  },
  {
    name: 'Terrazas de Cortesín',
    location: 'Málaga, España',
    status: 'Completada',
    type: 'Residencial premium',
    year: '2020',
    image: '/images/projects/terrazas-cortessin.png',
  },
  {
    name: 'Cayuco 11 Cap Cana',
    location: 'Cap Cana, República Dominicana',
    status: 'Completada',
    type: 'Villa residencial',
    year: '2023',
    image: '/images/projects/cayuco-11-cap-cana.png',
  },
  {
    name: 'Iguanas 45 Cap Cana',
    location: 'Cap Cana, República Dominicana',
    status: 'Completada',
    type: 'Villa residencial',
    year: '2023',
  ...
  {
    name: 'Villas Banús Bay',
    location: 'Marbella, España',
    status: 'Completada',
    type: 'Villas de lujo',
    year: '2019',
    image: '/images/projects/villas-banus-bay.png',
  },
  {
    name: 'Mar de Pulpí',
    ...
    type: 'Residencial',
    year: '2018',
    image: '/images/projects/mar-de-pulpi.png',
  },
  {
    name: 'Atalaya Emotion',
    location: 'España',
    status: 'Completada',
    type: 'Residencial',
    year: '2017',
    image: '/images/projects/atalaya-emotion.png',
  },
]

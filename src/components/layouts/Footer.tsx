...
export const Footer: FC = () => {
  ...
  const FOOTER_LINKS = {
    empresa: [
      { href: '/proceso', label: t.footer.nuestroProceso },
      { href: '/nosotros', label: t.footer.sobreNosotros },
      { href: '/contacto', label: t.footer.contacto },
      { href: '/blog', label: 'Blog' },
    ],
    servicios: [
      { href: '/villas', label: t.footer.proyectos },
      { href: '/inversores', label: t.footer.inversores },
      { href: '/servicios', label: t.footer.serviciosLabel },
    ],
    legal: [
      { href: '/privacidad', label: t.footer.politicaPrivacidad },
      { href: '/terminos', label: t.footer.terminosUso },
      { href: '/cookies', label: t.footer.politicaCookies },
    ],
  }
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              ...
              <a href="https://www.instagram.com/grupo_roiba/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-white/10 text-white/40 hover:border-roiba-dorado hover:text-roiba-dorado-light hover:bg-roiba-dorado/10 transition-all duration-300 rounded-sm" aria-label="Instagram">

...
export const blogPostFields: FormField[] = [
  ...
  { name: 'title', label: 'Título (ES)', required: true, placeholder: 'Por qué invertir en Punta Cana' },
  { name: 'title_en', label: 'Title (EN)', placeholder: 'Why invest in Punta Cana' },
  { name: 'excerpt', label: 'Extracto (ES)', type: 'textarea', rows: 2, placeholder: 'Breve resumen del artículo...' },
  { name: 'excerpt_en', label: 'Excerpt (EN)', type: 'textarea', rows: 2, placeholder: 'Brief article summary...' },
  { name: 'content', label: 'Contenido (ES)', type: 'textarea', rows: 10, placeholder: 'Contenido del artículo (HTML)...' },
  { name: 'content_en', label: 'Content (EN)', type: 'textarea', rows: 10, placeholder: 'Article content (HTML)...' },
  { name: 'image', label: 'URL de imagen', type: 'url', placeholder: 'https://...' },
  { name: 'category', label: 'Categoría (ES)', placeholder: 'Inversión' },
  { name: 'category_en', label: 'Category (EN)', placeholder: 'Investment' },
